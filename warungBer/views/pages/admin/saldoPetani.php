...
<body>
  ...
  <div class="container">
    ...
    <div class="col-md-6">
      <p><h1>Input Nominal Saldo Petani</h1></p>
      <div class="form">
        <form method="POST">
          <input type="hidden" name="controller" value="registerAdmin">
          <input type="hidden" name="action" value="saldoPetani">

          <div class="input-group">
            <span class="input-group-addon" id="basic-addon1"></span>
            <input name="saldo" type="text" class="form-control" placeholder="Masukkan Nominal Saldo Petani" aria-describedby="basic-addon1"
            required>
          </div>
          <br>
