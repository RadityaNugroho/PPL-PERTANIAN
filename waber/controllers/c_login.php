...
Class LoginController{
	...
	public function authentication(){
		...
		if(Login::find($_POST['username'],$_POST['password'])==0){
			...
			header("location:http://localhost/waber/index.php/home/homeAdmin");
		}elseif(Login::find($_POST['username'],$_POST['password'])==2){
			$_SESSION['login_user']=$_POST['username'];

			header("location:http://localhost/waber/index.php/home/homePenjual");
		}
		elseif(Login::find($_POST['username'],$_POST['password'])==3){
			$_SESSION['login_user']=$_POST['username'];
			header("location:http://localhost/waber/index.php/home/homePembeli");
		}
